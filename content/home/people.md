...
title = "The KALE Group"
subtitle = ""

[content]
  # Choose which groups/teams of users to display.
  #   Edit `user_groups` in each user's profile to add them to one or more of these groups.
  user_groups = ["Research Staff and Students",
                  "Collaborators",
                  "Alumni"]
  #               "Researchers",
  #               "Grad Students",
...
**PhD Position**: No scholarship available now. Email me **ONE PDF** including CV, a statement on why and your **source of funding**, 1-3 papers, and transcripts *before* applying. Check the [English language requirements](https://www.sheffield.ac.uk/postgraduate/phd/apply/english-language).
